-- TOPAC RH PRO - postos reais, QR vitalicio e regra de carro por unidade.
...
VALUES
  (
    ...
    '(11) 3333-6715',
    'ativo',
    'QR unico da Matriz. Carro preenchido pelo login do mecanico.'
  ),
  (
    'COMB-PG-001',
    ...
    'TOPAC PRAIA GRANDE',
    '46.778.064/0001-19',
    'Av. Ayrton Senna da Silva, 500, Xixova, Praia Grande/SP, CEP 11726-500',
    NULL,
    'ativo',
    'QR da Praia Grande. App exige selecao do carro.'
  ),
  (
    'COMB-GO-001',
...
BEGIN
  ...
  IF v_exige_selecao_carro AND coalesce(v_placa, '') = '' THEN
