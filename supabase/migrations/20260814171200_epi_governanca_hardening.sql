-- TOPAC RH PRO — hardening final e idempotente do modulo EPI
-- Garante que migrations intermediarias permissivas nao sobrevivam por OR no RLS.

-- Catalogo: leitura autenticada; escrita somente Admin.
...
-- Solicitacoes: operacao somente Admin. Diretoria aprova pelo relatorio formal/PDF.
...
-- Snapshot da solicitacao: somente Admin opera/consulta no modulo.
...
-- Fichas/entregas: escrita somente Admin; leitura escopada preservada.
...
-- Historico: inclusao somente Admin; leitura escopada preservada.
...
-- Identificacao de mecanico externo contem dados de acesso: somente Admin.
