...
const AdminMobileLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/30 flex flex-col">
        ...
        {isHome ? (
          <div className="space-y-5">
            ...
            <div className="px-1 pt-1">
              <h1 className="text-2xl font-bold tracking-tight">Ola, Rodrigo</h1>
            ...
            >
              ...
              <span>Buscar funcionario, empresa, modulo...</span>
            </button>

            {/* Grid 3 colunas - cards compactos */}
            <div>
              <div className="flex items-center justify-between mb-2 px-1">
                <h2 className="text-xs uppercase tracking-wider text-muted-foreground font-semibold">Acesso rapido</h2>
            ...
            <div className="rounded-2xl border border-border/60 bg-card p-4 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5">
                  Toque no microfone e diga, por exemplo: <i>"abrir funcionario Rafael Olimpio"</i> ou <i>"imprimir recibo de VR do Diego"</i>.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* FAB Voz (somente admin - este layout so renderiza para admin) */}
      <VoiceCommandFab />
      <AssistenteFab />
    </div>
  );
