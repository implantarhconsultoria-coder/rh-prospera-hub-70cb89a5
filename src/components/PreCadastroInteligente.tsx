  ...
  return (
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-h-[92vh] overflow-y-auto border-violet-500/40 bg-zinc-950 text-zinc-100 shadow-2xl sm:max-w-3xl [&_input]:bg-zinc-900 [&_input]:text-zinc-100 [&_input]:border-zinc-700 [&_input]:placeholder:text-zinc-500 [&_textarea]:bg-zinc-900 [&_textarea]:text-zinc-100 [&_textarea]:border-zinc-700 [&_textarea]:placeholder:text-zinc-500 [&_select]:bg-zinc-900 [&_select]:text-zinc-100 [&_select]:border-zinc-700 [&_option]:bg-zinc-900 [&_option]:text-zinc-100 [&_label]:text-zinc-200 [&_.text-muted-foreground]:text-zinc-300">
