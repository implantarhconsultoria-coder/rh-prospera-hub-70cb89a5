  ...
  const blocos = useMemo(() => {
    return companyIds
      ...
      .map(company => {
        ...
        const rows = buildVRReportRows(compEmps, compEntries, diasUteis);
    ...
    <>
      <style>{`
        ...
        @media print {
          ...
          .vr-bloco { page-break-after: always; }
          .vr-bloco:last-child { page-break-after: auto; }
      ...
      <div className="bg-white text-black min-h-screen print:bg-white" style={{ fontFamily: "'Segoe UI', Arial, sans-serif" }}>
        ...
        <div id="vr-print-area">
          {blocos.map(({ company, rows, totalFinal, dataFechamento }) => (
            <div key={company.id} className="vr-bloco max-w-[210mm] mx-auto px-8 py-6 print:px-6 print:py-4" style={{ fontSize: '11px' }}>
