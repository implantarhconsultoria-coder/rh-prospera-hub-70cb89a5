      ...
      <Dialog open={memoryOpen} onOpenChange={setMemoryOpen}>
        <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
          ...
          {resultado && <div className="space-y-3">
            ...
            <label className="flex items-start gap-2 border rounded p-3"><input type="checkbox" checked={confirmouFerias} onChange={(e) => setConfirmouFerias(e.target.checked)} className="mt-1" /><span><b>Conferi os períodos de férias utilizados nesta rescisão.</b><br/><small className="text-muted-foreground">Esta confirmação ficará refletida no snapshot/auditoria do cálculo.</small></span></label>
          </div>}
        </DialogContent>
      </Dialog>
