...
export const EQUIPMENT_LABEL_CATALOG: EquipmentLabelTemplate[] = [
  ...
  { id:'t9', category:'Equipamentos Pneumáticos', title:'Rompedor', brand:'TOPAC', model:'T9', spriteIndex:8, recommendedSize:'small', specs:['Peso: 8 kg','Pistão: 38 mm','Curso: 95 mm','Golpes por minuto: 1250','Ferramenta: cilíndrica','Consumo de ar: 31 PCM'] },
  { id:'t102', category:'Equipamentos Pneumáticos', title:'Rompedor', brand:'TOPAC', model:'T102', spriteIndex:9, recommendedSize:'small', specs:['Peso: 10,5 kg','Pistão: 38 mm','Curso: 95 mm','Golpes por minuto: 1250','Ferramenta: 7/8"','Consumo de ar: 31 PCM'] },
