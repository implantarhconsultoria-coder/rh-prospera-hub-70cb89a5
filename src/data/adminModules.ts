...
export const ADMIN_MODULE_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      {label:'Apontamento Inteligente',description:'Colar horas extras e comissões e lançar no fechamento',path:'/admin/fechamento?inteligente=1',icon:ClipboardPenLine},
